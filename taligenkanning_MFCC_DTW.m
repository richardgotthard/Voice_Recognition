...
% 
% figure
% spectrogram(test(:,1), winSize, overlap, fftsize, fs, 'yaxis')
...
% 
% %Fixa en if sats ifall ordet inte matchar 
% elseif ((ordsagt ~='datum') ||(ordsagt ~='hej') || (ordsagt ~='skamt'))
%     
% % [y,Fs] = audioread('datum.wav');
% % sound(y,Fs)
% disp('ERROR')
